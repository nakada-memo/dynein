...
If you need to avoid exceeding provisioned throughput, use `--consider-capacity` to throttle writes based on the table's write capacity when the target table is in Provisioned mode.
